...
// - Return the pointer.
 bool criteria (RouteModel::Node *node_1, RouteModel::Node *node_2 )
  {
    float sum1=node_1->h_value + node_1->g_value;
    float sum2=node_2->h_value + node_2->g_value;
    return sum1>sum2;
  }

RouteModel::Node *RoutePlanner::NextNode() {
 
  std::sort(this->open_list.begin(), this->open_list.end(), criteria);
  RouteModel::Node *pointer_to_min = open_list[open_list.size()-1];
